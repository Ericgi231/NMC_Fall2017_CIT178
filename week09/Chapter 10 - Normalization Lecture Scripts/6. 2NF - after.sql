...
ALTER TABLE NF2_SaleItem ADD CONSTRAINT PK_Invoice_Line PRIMARY KEY (InvoiceNo, LineNum);
ALTER TABLE NF2_SaleItem ADD CONSTRAINT FK_InvoiceNo FOREIGN KEY (InvoiceNo) REFERENCES NF2_SaleHead(InvoiceNo);
